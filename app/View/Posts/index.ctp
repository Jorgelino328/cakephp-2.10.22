...
<div class="jumbotron">
	<h1>Posts do Blog <?php if ($this->Session->read('Auth.User')) { echo $this->Html->link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-plus')) . " Criar Post", array('action' => 'add'), array( 'class'=>'btn btn-primary btn-lg', 'role'=>'button','escape' => false)); }?></h1>
